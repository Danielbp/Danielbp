;(function () {
    ...
    var RandomDungeon = {
        create: function() {
            ...
            this.player = game.add.sprite(this.player.x, this.player.y, "player", 1);
        ...
        makeMap: function() {
            ...
            for (var r=0; r<this.max_rooms; r++) {
                ...
                if (this.num_rooms == 0) {
                    ...
                    var new_x = this.math.snapToFloor(x + (w/2), 32);
                    var new_y = this.math.snapToFloor(y + (h/2), 32);

                    var prev_x = this.math.snapToFloor(this.lastRoomCoords.x, 32);
                    var prev_y = this.math.snapToFloor(this.lastRoomCoords.y, 32);
