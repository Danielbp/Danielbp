...
//7.3 hexagon
    ...
    function drawHexagon(hexa) {
        ...
        //Fill-inner
        var grd1 = ctx.createRadialGradient(800.000, 375.000, 0.000, 375.000, 375.000, 375.000);
        ...
        //Borders
        var grd = ctx.createRadialGradient(50.000, 375.000, 0.000, 375.000, 375.000, 375.000);
        ...
        //Text
        ctx.fillStyle = hexa.texthover;
        ctx.strokeStyle = 'white';
        ctx.font="20px PT Sans Caption";
        ctx.fillText( hexa.txt,hexa.tx,hexa.ty);
...
//drawlines(line);
    ...
    div1.style.left  = 126 + 'px';
    div1.style.top   = 430 + 'px';
    div1.style.width = '78px';
    div1.style.height = '78px';
    div1.style.borderRadius = '50px';
    div1.style.cursor = 'pointer';
    div1.onclick = function ()
    {
        var modal = new $.UIkit.modal("#contact");
    ...
    {
        var modal = new $.UIkit.modal("#about");
    ...
    div3.style.left  = 125 + 'px';
    div3.style.top   = 120 + 'px';
    div3.style.width = '78px';
    div3.style.height = '78px';
    div3.style.borderRadius = '50px';
    div3.style.cursor = 'pointer';
    div3.onclick = function ()
    {
        var modal = new $.UIkit.modal("#work");
    ...
    document.getElementById("canvas-wrap").appendChild(div1);
    document.getElementById("canvas-wrap").appendChild(div2);
    document.getElementById("canvas-wrap").appendChild(div3);
